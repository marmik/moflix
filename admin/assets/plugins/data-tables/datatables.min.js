 ...
 *   https://datatables.net/download/#bs4-4.0.0-beta/dt-1.10.16
 *
 * Included libraries:
 *   Bootstrap 4 4.0.0-beta, DataTables 1.10.16
 */
...
(function(h) {
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4-4.0.0-beta/dt-1.10.16",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
(function(b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-12 col-sm-6'l><'col-12 col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
        renderer: "bootstrap"
    });
    b.extend(f.ext.classes, {
        sWrapper: "dataTables_wrapper container-fluid dt-bootstrap4",
        sFilterInput: "form-control float",
