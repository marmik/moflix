    ...
    <div class="height-100-vh bg-primary-trans">
        <div class="container-fluid">
                    ...
                    <div class="login-div" style="padding-top: 20px;margin: 30px auto 30px; margin-bottom: 15px">
                     <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" name="login" id="needs-validation" novalidate>  
                        <div class="form-group">
                            <label>Login</label>
                            <input class="form-control input-lg" placeholder="Username" name="user_email" type="text" required>
                            <div class="invalid-feedback">This field is required.</div>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input class="form-control input-lg" placeholder="Password" name="user_password" type="password" required>
                            <div class="invalid-feedback">This field is required.</div>
                        </div>
          ...
          <div style="text-align: center; color: #fff; text-transform: uppercase; font-size: 10px;">
            Copyright &copy; 2020 <a href="https://www.bbitdevelopers.com" target="_blank" style="color: #fff; text-decoration: none;">BBIT Developers</a> - All Rights Reserved
        </div>
    </div>
</div>
</div>
