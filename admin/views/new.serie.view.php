          ...
          <div class="col-md-12">
            <div class="block form-block mb-4">
              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <label>Title</label>
                    <input class="form-control" value="" name="serie_title" type="text" required="">

                    <label>Description</label>

                    <textarea type="text" class="mceNoEditor form-control" rows="10" name="serie_description" id="serie_description" required=""></textarea>

                  </div>

                  <div class="form-group col-md-12">
                    <label>Year</label>
                    <input class="form-control" value="" name="serie_year" type="number" maxlength="4" required="">
                  </div>
                 ...
                 <div class="form-group col-md-12">
                  ...
                  <input class="form-control" data-role="tagsinput" value="" name="serie_stars" type="text" required="">
             ...
             <div class="form-group col-md-12">
              ...
              <input class="form-control" value="" name="serie_trailer" type="text">
            </div>
            ...
            <div class="form-group col-md-12">
             ...
             <div class="new-image" id="image-preview" style="height: 266px">
              ...
              <input type="file" name="serie_image" id="image-upload" required="" />
            </div>
