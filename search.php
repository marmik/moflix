...
UNION (SELECT song_id as id, song_slug as slug, song_image as image, song_title as title, song_year as year, 'song' as type FROM songs WHERE song_title LIKE '%" . $queryGet . "%' OR song_stars LIKE '%" . $queryGet . "%' AND song_status = 1)";
