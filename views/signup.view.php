        ...
        <div class="uk-overlay uk-text-center uk-vertical-align uk-height-1-1">
            ...
            <div class="uk-vertical-align uk-overlay-panel uk-overlay-background">
                <div class=" uk-vertical-align-middle uk-text-center uk-width-medium-4-10 uk-width-small-7-10 uk-width-large-2-10 uk-container-center">
                    ...
                    <form class="uk-form" action="<?php echo htmlspecialchars($urlPath->signup()); ?>" name="signup" method="post">
                        <h2 class="uk-margin-large-bottom uk-text-light"><?php echo _SIGNUP ?></h2>
                        ...
                        <div class="uk-form-row">
                            <div class="uk-form-icon uk-form-icon-flip uk-width-1-1">
                                <input type="text" name="user_name" class="uk-width-1-1" placeholder="<?php echo _USERNAME ?>" required>
                                <i class="uk-icon-user"></i>
                            </div>
                            <div id="user_name_validate" class="validation"></div>
                        </div>
                        ...
                        <div class="uk-form-row uk-text-small">
                            <label class="uk-float-left">
                                <input type="checkbox" name="terms" required> <?php echo _IAGREETOTERMS ?>
                            </label>
                        </div>
                        ...
                        <div class="uk-form-row uk-float-left uk-text-muted">
                            <?php echo _ALREADYHAVEAN ?> <a class="uk-link-muted" href="<?php echo $urlPath->signin(); ?>"><?php echo _SIGNIN ?></a>
                        </div>
